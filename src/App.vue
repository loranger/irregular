  ...
  <main class="grid min-h-screen place-items-center bg-white dark:bg-black px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
      ...
      @click="state.expand = !state.expand"
        class="min-h-[15rem] flex flex-col justify-around">
        <Transition>
          <div class="" v-if="state.expand">
            <p class="text-xs font-semibold text-indigo-600 dark:text-indigo-400">Past simple</p>
        ...
        <Transition>
          <div class="" v-if="state.expand">
            <p class="text-xs font-semibold text-indigo-600 dark:text-indigo-400">Past participle</p>
        ...
        <Transition>
          <div class="" v-if="state.expand">
            <p class="text-xs font-semibold text-indigo-600 dark:text-indigo-400">French 🇫🇷</p>
      ...
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <button type="button" class="rounded-md bg-indigo-600 px-3 py-2 text-xl font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" @click="randomVerb()">Random verb</button>
      </div>
    </div>
  </main>
